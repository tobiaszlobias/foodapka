...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex h-[calc(100vh-4rem)] w-72 flex-col gap-2 rounded-r-[2rem] bg-foodapka-50/80 dark:bg-foodapka-950/90 p-6 shadow-[0px_20px_40px_rgba(0,33,20,0.08)] dark:shadow-none fixed top-16 left-0 z-40">
